...
function createElements(object, loop) {
  for (var property in object) {
    ...
    } else if (loop && typeof object[property] !== 'string' && typeof object[property] !== 'number' && typeof object[property] !== 'boolean') {
...
function drawToLayer(layer) {
  ...
  blueprints.forEach(blueprint => {
    ...
    context.drawImage($variation, 0, 0, variation.width, variation.height, x, y, variation.width, variation.height);
...
function renderLayer(layer) {
  ...
  var $camera = document.getElementById(camera.elementID);
  var context = $camera.getContext('2d');
  if (layer.x) var layerX = layer.x;else layerX = 0;
  ...
  context.drawImage($layer, cameraX, camera.y, camera.width, camera.height, 0, 0, camera.width, camera.height);
  context.setTransform(1, 0, 0, 1, 0, 0);
}
...
},{"./transport":16,"./transports/index":17,"component-emitter":23,"debug":11,"engine.io-parser":24,"indexof":28,"parsejson":32,"parseqs":33,"parseuri":34}],16:[function(require,module,exports){
/**
 * Module dependencies.
 */
...
},{"../transport":16,"component-inherit":10,"debug":11,"engine.io-parser":24,"parseqs":33,"xmlhttprequest-ssl":22,"yeast":50}],21:[function(require,module,exports){
(function (global){
/**
 * Module dependencies.
 */
...
},{"../transport":16,"component-inherit":10,"debug":11,"engine.io-parser":24,"parseqs":33,"ws":7,"yeast":50}],22:[function(require,module,exports){
(function (global){
...
},{"./keys":25,"after":2,"arraybuffer.slice":3,"base64-arraybuffer":5,"blob":6,"has-binary":26,"wtf-8":49}],25:[function(require,module,exports){
...
},{"./on":38,"./socket":39,"backo2":4,"component-bind":8,"component-emitter":41,"debug":11,"engine.io-client":13,"indexof":28,"socket.io-parser":43}],38:[function(require,module,exports){
...
},{"./on":38,"component-bind":8,"component-emitter":41,"debug":11,"has-binary":26,"socket.io-parser":43,"to-array":48}],40:[function(require,module,exports){
(function (global){
