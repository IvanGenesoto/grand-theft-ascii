module.exports = function Characters(arg) {
  ...
  const charactersPrototype = $('../entities-prototype')(_characters)

  const entities = Object.entries($('../../entities/global-methods/characters'))
  entities.forEach(entity => $('../append/global-methods')(entity))

  const characters = Object.create(charactersPrototype)
